...
use Tickit\Bundle\ProjectBundle\Controller\PickerController;
...
class PickerControllerTest extends AbstractUnitTest
{
     ...
     */
    public function testFindAction($term, array $expectedFilters)
    {
        ...
        $this->filterCollectionBuilder->expects($this->once())
                                      ...
                                      ->with($expectedFilters, new ProjectFilterMapper(), FilterCollection::JOIN_TYPE_OR)
    ...
    {
        return [
            ['website build', ['name' => 'website build']]
        ];
    }
    ...
    {
        return new PickerController($this->projectRepository, $this->baseHelper, $this->filterCollectionBuilder);
    }
}
