...
/**
 * Event fired before a user is created in the application
 *
 * @package Tickit\UserBundle\Event
 * @author  James Halsall <james.t.halsall@googlemail.com>
 */
class BeforeCreateEvent extends AbstractVetoableEvent implements UserAwareInterface
{
    /**
     ...
     * Constructor.
     *
     * @param User $user The user entity that is to be created
     */
